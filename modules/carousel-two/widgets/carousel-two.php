...
namespace NobelMagazineAddons\Modules\CarouselTwo\Widgets;
...
class Carousel_Two extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('News Carousel Two', 'nobel-magazine-addons');
    }

    /** Icon */
    public function get_icon() {
        return 'nma-elements nma-carousel-two';
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_group_control(
            ...
            'types' => ['gradient'],
            'selector' => '{{WRAPPER}} .nma-post-content',
                ]
        );
    ...
    protected function render() {
        ...
        <div class="nma-post-carousel-block">
            ...
            <?php if ($post_query->have_posts()) : ?>
                <div class="nma-post-carousel-two owl-carousel" data-params='<?php echo $params; ?>'>
