...
namespace NobelMagazineAddons\Modules\BlockThree\Widgets;
...
class Block_Three extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('News Block Three', 'nobel-magazine-addons');
    }

    /** Icon */
    public function get_icon() {
        return 'nma-elements nma-block-three';
    }
    ...
    protected function render() {
        ...
        $this->add_render_attribute('nma-post-block-three', 'class', [
            'nma-post-block-three',
            'nma-pbt-col-' . $settings['layout_col']['size'],
            'nma-pbt-tablet-col-' . $settings['layout_col_tablet']['size'],
            'nma-pbt-mobile-col-' . $settings['layout_col_mobile']['size']
                ]
        );
        ?>
        <div class="nma-post-block">
            ...
            <?php if ($post_query->have_posts()) { ?>
                <div <?php echo $this->get_render_attribute_string('nma-post-block-three'); ?>>
                    <?php
