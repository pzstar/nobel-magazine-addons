...
namespace NobelMagazineAddons\Modules\SingleNewsThree\Widgets;
...
class Single_News_Three extends Widget_Base {
    ...
    public function get_name() {
        return 'nma-single-news-three';
    }

    /** Widget Title */
    public function get_title() {
        return esc_html__('Single News Three', 'nobel-magazine-addons');
    }

    /** Icon */
    public function get_icon() {
        return 'nma-elements nma-single-news-three';
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            'default' => '#000000',
            'selectors' => [
                '{{WRAPPER}} .nma-post-title a' => 'background-color: {{VALUE}}',
            ],
                ]
        );
    ...
    protected function render() {
        ...
        <div class="nma-single-post">
            ...
            if ($post_query->have_posts()) {
                ?>
                <div class="nma-single-post-three">
                    <?php
