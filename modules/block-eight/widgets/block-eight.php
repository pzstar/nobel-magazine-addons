...
namespace NobelMagazineAddons\Modules\BlockEight\Widgets;
...
class Block_Eight extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('News Block Eight', 'nobel-magazine-addons');
    }

    /** Icon */
    public function get_icon() {
        return 'nma-elements nma-block-eight';
    }
    ...
    protected function render() {
        ...
        <div class="nma-post-block">
            ...
            <?php if ($post_query->have_posts()) { ?>
                <div class="nma-post-block-eight">
                    <?php
