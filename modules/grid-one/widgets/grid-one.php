...
namespace NobelMagazineAddons\Modules\GridOne\Widgets;
...
class Grid_One extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('News Grid One', 'nobel-magazine-addons');
    }

    /** Icon */
    public function get_icon() {
        return 'nma-elements nma-grid-one';
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .nma-post-grid-one' => 'gap: {{SIZE}}{{UNIT}};',
            ],
                ]
        );
