...
namespace NobelMagazineAddons\Modules\BlockTwo\Widgets;
...
class Block_Two extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('News Block Two', 'nobel-magazine-addons');
    }

    /** Icon */
    public function get_icon() {
        return 'nma-elements nma-block-two';
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .nma-post-block-two .nma-top-block h3.nma-post-title a' => 'color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_group_control(
            ...
            'label' => esc_html__('Typography', 'nobel-magazine-addons'),
            'scheme' => Scheme_Typography::TYPOGRAPHY_1,
            'selector' => '{{WRAPPER}} .nma-post-block-two .nma-top-block h3.nma-post-title',
                ]
        );
        ...
        $this->add_control(
            ...
            'size_units' => ['px', '%', 'em'],
            'selectors' => [
                '{{WRAPPER}} .nma-post-block-two .nma-top-block h3.nma-post-title' => 'margin: {{TOP}}{{UNIT}} 0 {{BOTTOM}}{{UNIT}} 0;',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .nma-post-block-two .nma-bottom-block h3.nma-post-title a' => 'color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_group_control(
            ...
            'label' => esc_html__('Typography', 'nobel-magazine-addons'),
            'scheme' => Scheme_Typography::TYPOGRAPHY_1,
            'selector' => '{{WRAPPER}} .nma-post-block-two .nma-bottom-block h3.nma-post-title a',
                ]
        );
        ...
        $this->add_control(
            ...
            'size_units' => ['px', '%', 'em'],
            'selectors' => [
                '{{WRAPPER}} .nma-post-block-two .nma-bottom-block h3.nma-post-title' => 'margin: {{TOP}}{{UNIT}} 0 {{BOTTOM}}{{UNIT}} 0;',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .nma-post-block-two .nma-post-excerpt' => 'color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_group_control(
            ...
            'label' => esc_html__('Typography', 'nobel-magazine-addons'),
            'scheme' => Scheme_Typography::TYPOGRAPHY_1,
            'selector' => '{{WRAPPER}} .nma-post-block-two .nma-post-excerpt',
                ]
        );
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .nma-post-block-two .nma-post-meta span' => 'color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_group_control(
            ...
            'label' => esc_html__('Typography', 'nobel-magazine-addons'),
            'scheme' => Scheme_Typography::TYPOGRAPHY_1,
            'selector' => '{{WRAPPER}} .nma-post-block-two .nma-post-meta span',
                ]
        );
