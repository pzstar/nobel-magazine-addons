...
namespace NobelMagazineAddons\Modules\SingleNewsOne\Widgets;
...
class Single_News_One extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Single News One', 'nobel-magazine-addons');
    }

    /** Icon */
    public function get_icon() {
        return 'nma-elements nma-single-news-one';
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
                'content_style', [
            'label' => esc_html__('Content', 'nobel-magazine-addons'),
        ...
        $this->add_control(
                'content_bg', [
            'label' => esc_html__('Backgorund', 'nobel-magazine-addons'),
        ...
        $this->add_control(
            ...
            'size_units' => ['px', '%', 'em'],
            'selectors' => [
                '{{WRAPPER}} .nma-post-content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ],
                ]
        );
        ...
        $this->add_control(
            ...
            'size_units' => ['px', '%', 'em'],
            'selectors' => [
                '{{WRAPPER}} .nma-post-content' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ],
                ]
        );
