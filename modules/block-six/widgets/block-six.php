...
namespace NobelMagazineAddons\Modules\BlockSix\Widgets;
...
class Block_Six extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('News Block Six', 'nobel-magazine-addons');
    }

    /** Icon */
    public function get_icon() {
        return 'nma-elements nma-block-six';
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .nma-post-list .nma-post-thumb' => 'min-width: {{SIZE}}{{UNIT}};',
            ],
                ]
        );
        ...
        $this->add_control(
                'round_thumbnail', [
            'label' => esc_html__('Round Thumbnail', 'nobel-magazine-addons'),
            'type' => Controls_Manager::SWITCHER,
            'label_on' => esc_html__('Yes', 'nobel-magazine-addons'),
            'label_off' => esc_html__('No', 'nobel-magazine-addons'),
            'return_value' => 'yes',
            'description' => esc_html__('Set Image Height to 100% for round thumb', 'nobel-magazine-addons'),
                ]
        );
    ...
    protected function render() {
        ...
        $round_thumb_class = $settings['round_thumbnail'] == 'yes' ? 'nma-round-thumb' : '';
        ?>
        <div class="nma-post-block">
            ...
            if ($post_query->have_posts()) {
                ?>
                <div class="nma-post-block-six <?php echo esc_attr($round_thumb_class); ?> nma-thumb-position-<?php echo esc_attr($settings['thumb_position']); ?> nma-row nma-col-<?php echo esc_attr($column_count) ?> nma-tablet-col-<?php echo esc_attr($column_count_tablet) ?> nma-mobile-col-<?php echo esc_attr($column_count_mobile) ?>">
                    <?php
