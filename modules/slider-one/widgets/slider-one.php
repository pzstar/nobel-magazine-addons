...
namespace NobelMagazineAddons\Modules\SliderOne\Widgets;
...
class Slider_One extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('News Slider One', 'nobel-magazine-addons');
    }

    /** Icon */
    public function get_icon() {
        return 'nma-elements nma-slider-one';
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
                'content_box_style', [
            'label' => esc_html__('Content Box', 'nobel-magazine-addons'),
            'tab' => Controls_Manager::TAB_STYLE,
                ]
        );
        ...
        $this->add_control(
            ...
            'label' => esc_html__('Background Color', 'nobel-magazine-addons'),
            'type' => Controls_Manager::COLOR,
            'scheme' => [
                'type' => Scheme_Color::get_type(),
                'value' => Scheme_Color::COLOR_1,
            ...
            'selectors' => [
                '{{WRAPPER}} .nma-post-content' => 'background-color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_control(
                'nav_icon_color', [
            'label' => esc_html__('Navigation Icon Color', 'nobel-magazine-addons'),
            'type' => Controls_Manager::COLOR,
            'scheme' => [
                'type' => Scheme_Color::get_type(),
                'value' => Scheme_Color::COLOR_1,
            ...
            'selectors' => [
                '{{WRAPPER}} .nma-post-slider-one .owl-prev, {{WRAPPER}} .nma-post-slider-one .owl-next' => 'color: {{VALUE}}',
            ],
                ]
        );
    ...
    protected function render() {
        ...
        ?>
        <div class="nma-post-slider-block">
            <!-- Heading -->
            <?php $this->render_header(); ?>

            <!-- Post Lists -->
            <?php if ($post_query->have_posts()) : ?>
                <div class="nma-post-slider-one owl-carousel" data-params='<?php echo $params; ?>'>
