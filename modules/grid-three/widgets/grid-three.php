...
namespace NobelMagazineAddons\Modules\GridThree\Widgets;
...
class Grid_Three extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('News Grid Three', 'nobel-magazine-addons');
    }

    /** Icon */
    public function get_icon() {
        return 'nma-elements nma-grid-three';
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .nma-post-list' => 'padding: calc( {{SIZE}}{{UNIT}}/2 );',
                '{{WRAPPER}} .nma-post-grid-three' => 'margin: calc( -{{SIZE}}{{UNIT}}/2 );',
            ],
                ]
        );
    ...
    protected function render() {
        ...
        $this->add_render_attribute('nma-post-grid-three', 'class', [
            'nma-post-grid-three',
            'nma-row',
            'nma-col-' . $settings['column_count']['size'],
            'nma-tablet-col-' . $settings['column_count_tablet']['size'],
            'nma-mobile-col-' . $settings['column_count_mobile']['size']
                ]
        );
        ...
        <div class="nma-post-grid-block">
            ...
            <?php if ($post_query->have_posts()) : ?>
                <div <?php echo $this->get_render_attribute_string('nma-post-grid-three'); ?>>
                    <?php
