...
namespace NobelMagazineAddons\Modules\GridFour\Widgets;
...
class Grid_Four extends Widget_Base {
    ...
    public function get_name() {
        return 'nma-news-grid-four';
    }

    /** Widget Title */
    public function get_title() {
        return esc_html__('News Grid Four', 'nobel-magazine-addons');
    }

    /** Icon */
    public function get_icon() {
        return 'nma-elements nma-grid-four';
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .nma-post-grid-four' => 'gap: {{SIZE}}{{UNIT}};',
            ],
                ]
        );
    ...
    protected function get_post_title() {
        ?>
        <h3 class="nma-post-title"><a href="<?php the_permalink(); ?>"><span><?php echo esc_html(get_the_title()); ?></span></a></h3>
        <?php
    }
