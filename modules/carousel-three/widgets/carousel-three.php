...
namespace NobelMagazineAddons\Modules\CarouselThree\Widgets;
...
class Carousel_Three extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('News Carousel Three', 'nobel-magazine-addons');
    }

    /** Icon */
    public function get_icon() {
        return 'nma-elements nma-carousel-three';
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            'size_units' => ['px', '%', 'em'],
            'selectors' => [
                '{{WRAPPER}} .nma-post-thumb-container:after' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ],
                ]
        );
        ...
        $this->add_group_control(
            ...
            'types' => ['gradient'],
            'selector' => '{{WRAPPER}} .nma-post-thumb-container:after',
                ]
        );
    ...
    protected function render() {
        ...
        <div class="nma-post-carousel-block">
            ...
            <?php if ($post_query->have_posts()) : ?>
                <div class="nma-post-carousel-three owl-carousel" data-params='<?php echo $params; ?>'>
                        ...
                        <div class="nma-post-slides">
                            <div class="nma-post-image">
                                ...
                                <div class="nma-post-content">
                                    <div class="nma-post-content-wrap">
