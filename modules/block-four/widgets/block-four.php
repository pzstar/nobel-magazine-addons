...
namespace NobelMagazineAddons\Modules\BlockFour\Widgets;
...
class Block_Four extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('News Block Four', 'nobel-magazine-addons');
    }

    /** Icon */
    public function get_icon() {
        return 'nma-elements nma-block-four';
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .nobel-magazine-post-main-header, {{WRAPPER}} .nobel-magazine-post-main-header a' => 'color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_group_control(
            ...
            'selector' => '{{WRAPPER}} .nobel-magazine-post-main-header, {{WRAPPER}} .nobel-magazine-post-main-header a',
                ]
        );
        ...
        $this->add_control(
            ...
            'selectors' => [
                '{{WRAPPER}} .nma-left-block .nma-post-excerpt' => 'color: {{VALUE}}',
            ],
                ]
        );
        ...
        $this->add_group_control(
            ...
            'label' => esc_html__('Typography', 'nobel-magazine-addons'),
            'scheme' => Scheme_Typography::TYPOGRAPHY_1,
            'selector' => '{{WRAPPER}} .nma-left-block .nma-post-excerpt',
                ]
        );
    ...
    protected function render() {
        ...
        $this->add_render_attribute('nma-post-block-four', 'class', [
            'nma-post-block-four',
            'nma-pbf-col-' . $settings['layout_col']['size'],
            'nma-pbf-tablet-col-' . $settings['layout_col_tablet']['size'],
            'nma-pbf-mobile-col-' . $settings['layout_col_mobile']['size']
                ]
        );
        ?>
        <div class="nma-post-block">
            ...
            <?php if ($post_query->have_posts()) { ?>
                <div <?php echo $this->get_render_attribute_string('nma-post-block-four'); ?>>
                    <?php
                        ...
                        <?php if ($current_post_count == 1) { ?>
                            ...
                            <div class="nma-post-list <?php echo esc_attr($post_list_class); ?>">
                                ...
                                if ($current_post_count <= (int) $featured_post_count + 2) {
                                    nobel_magazine_addons_image($image_size);
                                }
                                ?>
